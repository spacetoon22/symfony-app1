...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\ManyToMany(targetEntity: Prospect::class, mappedBy: 'assingedTo')]
    ...
    /**
     * Returns the display name: username if set, otherwise falls back to email.
     */
    ...
    public function removeProspect(Prospect $prospect): static
    {
        if ($this->prospects->removeElement($prospect)) {
            $prospect->removeAssingedTo($this);
        }
