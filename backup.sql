...
CREATE TABLE `dossier` (
  ...
  `medical_notes` longtext COLLATE utf8mb4_unicode_ci,
  `commercial_notes` longtext COLLATE utf8mb4_unicode_ci,
  `documents` json DEFAULT NULL,
  `status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rejection_note` longtext COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `dossier` VALUES (11,'way2','way2','ae456598','male','2026-02-07','alex@gmail.ma','0600000000','way2','','basic','2026-01-31',1,'diabetes',6,'','','[\"cin\", \"contract\"]','approved',NULL,'2026-02-26 13:45:32',11,'[\"1772113532_726f7cb8_NumPy_Python_DS_2026.pdf\", \"1772113532_cab46071_DEVIS_AKSAM_CASQUE_IPPHONE_.pdf\"]',11,NULL),(12,'karim','li','ae456598','female','6999-05-15','karim@gmai.ma','0600000000','casa','','premium','1899-08-19',3,'hypertension',320,'','','[\"photo\", \"contract\"]','approved',NULL,'2026-02-26 15:51:22',9,'[\"1772121082_215cf502_PW1_-_Class_diagrams.pdf\", \"69a06c2c7cd13_signature.PNG\", \"69a06c2c7ce27_The-Standard-CBIC-Medicaid-Card.png\", \"69a06c3cecbe5_FICHIER DE PASSATIO.pdf\", \"69a06cdf74975_key programme.PNG\"]',9,NULL),(13,'Nada','kira','ab1123','female','1994-03-02','Nada@gmail.ma','0600000055','fes','','family','2026-04-01',1,'other',1500,'Cancer','','[]','approved',NULL,'2026-03-02 11:01:58',11,'[\"69a56ec24f618_The-Standard-CBIC-Medicaid-Card.png\"]',11,NULL),(14,'Mane','kalulu','D6925','male','1980-03-19','mane@gmail.ma','0600000055','casa','','basic','2026-03-19',1,'none',450,'','','[]','rejected','no \r\n','2026-03-02 11:49:00',9,'[\"69a57995e8b0e_signature.PNG\"]',9,NULL),(15,'mer','cedi','CF4598','male','2026-03-27','mer@gmail.ma','0600000000','casa','','standard','2026-03-19',1,'none',260,'',NULL,'[]','review',NULL,'2026-03-02 14:10:13',9,'[]',9,'taxi'),(16,'alex','kira','ab1123','male','2026-03-06','alex44@gmail.ma','0600000000','casa','','standard','2026-03-06',1,'diabetes',200,'','','[]','approved',NULL,'2026-03-04 10:40:33',9,'[\"69a80c5609b61_The-Standard-CBIC-Medicaid-Card.png\"]',9,'health'),(17,'Ahmed','Test',NULL,NULL,NULL,'ahmed@test.com','0612345678','Rabat',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]','pending',NULL,'2026-03-06 15:33:48',NULL,'[]',NULL,'health');
...
INSERT INTO `user` VALUES (1,'Admin_OSS@gmail.ma','[\"ROLE_ADMIN\"]','$2y$13$ammus8p5bfJmGUfkbKACu.donoreoc5I/cCWVnU.r6N2G456jKrrC','ADMIN'),(4,'user3_OSS@gmail.ma','[\"ROLE_COMMERCIAL\"]','$2y$13$AXZjzTxH3a96MNCkxrF6luq4CmgpYuYyhhWkkVMux/QaTU1LnpKNC','user3'),(9,'Hana@gmail.ma','[\"ROLE_COMMERCIAL\"]','$2y$13$zUZ8TCcsTOKIzZfzcvIfnO9to35DwcBe11Vn2OafxrNK7hQU4NBY2','Hana'),(11,'way2@example.ma','[\"ROLE_COMMERCIAL\"]','$2y$13$Gy2Lrq7EnFHKz/TvBMQDMOnai/.Ct/gchkGbFrTqyXmCJEz29kNVS','way'),(17,'ahmed@gg.gg','[\"ROLE_ADMIN\"]','Ahmed123',NULL),(18,'cloud@gmail.com','[\"ROLE_COMMERCIAL\"]','$2y$13$Ma7V5OtLZWLmGNsNn2AkjOScmvYBXPzWjKQIEgjuL6PeYFh199HPi','Cloud');
...
-- Dump completed on 2026-03-09 10:46:38
